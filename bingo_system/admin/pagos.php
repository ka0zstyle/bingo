                    ...
                    <div class="payment-card" id="payment-card-<?php e($purchase['id']); ?>" data-id="<?php e($purchase['id']); ?>" data-search-term="<?php e(strtolower($purchase['owner_name'] . ' ' . $purchase['owner_email'] . ' ' . $purchase['event_name'] . ' ' . $purchase['payment_ref'])); ?>">
                        ...
                        <div class="payment-details">
                            ...
                            <?php if ($status_filter !== 'pending'): ?>
                                <div class="detail-item"><strong>Procesado por:</strong> <?php e($purchase['processed_by_username'] ?? '—'); ?></div>
                                <?php if (!empty($purchase['processed_at'])): ?>
                                    <div class="detail-item"><strong>Procesado el:</strong> <?php e(date('d/m/Y H:i', strtotime($purchase['processed_at']))); ?></div>
                                <?php endif; ?>
                            <?php endif; ?>
                        </div>
