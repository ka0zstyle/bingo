...
/* =========================
   Monedas
   ========================= */
$stmt_currencies = $pdo->query("SELECT code, symbol FROM currencies");
...
<div class="admin-section">
    ...
    <div style="margin-bottom:1rem;">
        <input type="search" id="payment-search" placeholder="Buscar por cliente, email, evento o referencia" style="border-radius:999px;border:1px solid #cbd5e1;padding:10px 12px;outline:none;width:100%;">
    </div>
        ...
        <div class="payments-list">
            ...
            <?php else: ?>
                <?php foreach ($purchases as $purchase): ?>
                    <div class="payment-card" data-id="<?php e($purchase['id']); ?>" data-search-term="<?php e(strtolower($purchase['owner_name'] . ' ' . $purchase['owner_email'] . ' ' . $purchase['event_name'] . ' ' . $purchase['payment_ref'])); ?>">
